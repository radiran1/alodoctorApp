(function () {
	'use strict';
	angular.module('alodoctorApp').factory('alodoctorApi', ['$http', alodoctorApi]);
	function alodoctorApi($http) {
		...
		function getNotes(callback) {
			$http({
				...
				callback(data); // assign  $scope.persons here as promise is resolved here 
			});
		};
